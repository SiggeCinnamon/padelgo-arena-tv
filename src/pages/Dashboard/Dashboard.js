        ...
        <>
            <div className="vertical-center">
                <div className="btn-div">
                    <Link className="btn btn-primary" to={`${Routes.COURTS}/${court}`}>Arena TV</Link>
                </div>
                <div className="btn-group" role="group" aria-label="Court selector">
                    <div className="select-div">
                        <select className="form-select" aria-label="Default select example" value={court} onChange={(e) => { setCourt(e.currentTarget.value) }}>
